...
# === Solution 2 (slice) ===
#
# Array::slice method can be called to convert Array-like objects / collections to a new Array
module.exports = ->
  Array::slice.call(arguments).filter (object) ->
    Object::hasOwnProperty.call(object, 'quack')
  .length
